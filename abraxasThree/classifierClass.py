...
if __name__ == '__main__':
    ...
    # user identification:
    # """
    a = AbraxasClassifier(numIrSensors=10, numFrSensors=2, windowWidth=100, windowShift=25, numFreqs=3, numCoeffs=15,
    ...
    xg.setWindowFunction(functionName='tukey', alpha=0.1)
    # a.plotWindowFunction()

    xg.selectSensorSubset(selectedSensors=[False, False, False], sensorType='bno')
    ...
    xg.addDataFiles(fileSourceName="ben.txt", fileSourcePath="../", startTime=2000, stopTime=6000, label=5)

    xg.addDataFiles(fileSourceName="stefan.txt", fileSourcePath="../", startTime=500, stopTime=6000, label=6)
