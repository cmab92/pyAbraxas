...
#irData, forceData, quatData, linAccData, angVecData = loadAndClean("sashi_20185291449.txt", 10, 4, tSample = 0.0165, dirPath = "/home/bonenberger/Dokumente/Rabe/Daten/dataRABE/")
dir = "schnellChris_20185291452.txt"
irData, forceData, quatData, linAccData, angVecData = loadAndClean(dir, 10, 4, tSample = 0.0165, dirPath = "/home/bonenberger/Dokumente/Rabe/Daten/dataRABE/")
## denoise
...
for i in range(len(irData)):
    ...
    for j in range(len(irData)):
        corrXtemp.append(pd.Series(data).corr(other=pd.Series(irData[j][1000:7000,1])))
